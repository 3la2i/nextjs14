  ...
  return (
    <div className="min-h-screen bg-white">
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-green-700 mb-8 text-center">Contact Us</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="mt-1 block w-full px-3 py-2 bg-white border border-green-200 rounded-md text-green-700 shadow-sm focus:outline-none focus:ring-green-700 focus:border-green-700"
                />
              </div>
              <div>
              ...
              <button
                ...
                className="w-full bg-green-600 text-white hover:bg-green-700 px-4 py-2 rounded-md font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-700 disabled:opacity-50"
              >
          ...
          <div className="space-y-6">
            <div className="bg-green-50 rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-green-700">support@eco-actiontracker.com</span>
                </div>
                <div className="flex items-center space-x-3">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-green-700">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-green-700">123 Eco Street, Green City, EC 12345</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 rounded-lg shadow-md p-6">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-green-700 hover:text-green-600">Facebook</a>
                <a href="#" className="text-green-700 hover:text-green-600">Twitter</a>
                <a href="#" className="text-green-700 hover:text-green-600">Instagram</a>
                <a href="#" className="text-green-700 hover:text-green-600">LinkedIn</a>
              </div>
            </div>
            ...
            <div className="bg-green-50 rounded-lg shadow-md p-6">
              ...
              <button className="mt-4 text-green-700 hover:text-green-600 underline">
                View all FAQs
              </button>
            </div>
          </div>
